<div class="text-center my-3">
    <a href="index.php"  class="btn btn-primary <?= !$oPlayer || !$oPlayer->getCharacter()->isDead() ? 'disabled' : ''; ?>" >
        Nouvelle partie
    </a>

    <button type="button" class="btn btn-primary <?= $oPlayer ? 'disabled' : ''; ?>" data-bs-toggle="modal" data-bs-target="#NewPlayerModal">
