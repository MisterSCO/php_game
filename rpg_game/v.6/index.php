    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $modalNewPlayer.on('click', '.player-type', function() {
                ...
                var sCharacterId = $(this).data('id');

                if (sPlayerName === '') {
                    return;
                }

                refreshChoosePlayer('action=create_player&player_name='+ sPlayerName + '&character_name='+ sCharacterName + '&character_class='+ sCharacterClass + '&character_id='+ sCharacterId);
            ...
            $modalNewPlayer.find('.btn-primary').on('click', function() {
                var $activePlayer = $('.player-type.active');
                ...
                var sPlayerName = $('#PlayerName').val();
                var sCharacterName = $('#CharacterName').val();
                var sPlayerClass = $activePlayer.data('class');
                var sCharacterId = $activePlayer.data('id');

                if ((sPlayerName === '') || (sCharacterName === '')) {
                    return;
                }

                refreshChoosePlayer('action=create_player&player_name='+ sPlayerName + '&character_class='+ sPlayerClass + '&character_name='+ sCharacterName + '&character_id='+ sCharacterId + '&save=1');

                $modalNewPlayer.find('.btn-close').click();
                refreshBoard('action=refresh');
            });
        });
    </script>
